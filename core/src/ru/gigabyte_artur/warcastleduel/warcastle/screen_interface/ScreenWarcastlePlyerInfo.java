...
public class ScreenWarcastlePlyerInfo extends ScreenRectangledElement
{
    ...
    private BitmapFont ActiveNameFont;
    ...
    public ScreenWarcastlePlyerInfo()
    {
        ...
        ActiveNameFont = new BitmapFont();
        ActiveNameFont.setColor(Color.RED);
    }
    ...
    public void draw(SpriteBatch batch)
    {
        ...
        if (LinkedPlayer != null) {
            ...
            // Строка имени.
            if (isActivePlayer)
                ActiveNameFont.draw(batch, "Name: " + LinkedPlayer.getName(), CurrentX, ScreenHeight - (CurrentY + 0));
            else
        ...
        {
            // Нет подключенного игрока. Не отрисовываем.
        }
    }
}
